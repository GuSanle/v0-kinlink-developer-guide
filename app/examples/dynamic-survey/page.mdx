...
<div className="container py-6 lg:py-10">
  <div className="flex items-center gap-4 mb-8">
    ...
    <h1 className="text-3xl font-bold tracking-tight">智能动态调查表单示例</h1>
  </div>

    <div className="my-8 space-y-6">
    <div className="space-y-4">
      <h2 className="text-2xl font-bold tracking-tight">动态调查系统概览</h2>
      > 构建自适应调查问卷，实现条件分支逻辑和个性化问题流程

      此示例演示如何创建**智能动态调查表单**，根据用户的答案自动显示或隐藏相关问题。通过**条件逻辑**和**分支控制**，创建更加个性化和高效的调查体验。
