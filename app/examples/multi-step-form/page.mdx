...
<div className="container py-6 lg:py-10">
  <div className="flex items-center gap-4 mb-8">
    ...
    <h1 className="text-3xl font-bold tracking-tight">多步骤表单流程控制示例</h1>
  </div>

  <div className="my-8 space-y-6">
    <div className="space-y-4">
      <h2 className="text-2xl font-bold tracking-tight">分步表单系统概览</h2>
      > 构建用户友好的分步填写体验，实现复杂表单的逐步引导和验证

      此示例演示如何创建**智能多步骤表单**，将复杂的表单分解为**逐步填写**的简单步骤。通过**进度指示**、**步骤验证**和**数据保存**，提供流畅的用户体验。

      ### 分步表单核心特性
      - 📊 **进度跟踪**：可视化显示当前进度和剩余步骤
      - ✅ **分步验证**：每个步骤独立验证，减少用户挫败感
      - 💾 **状态保存**：支持中途保存和继续填写
      - 🔄 **灵活导航**：支持前进、后退和跳转操作
      - 🎯 **条件分支**：基于答案显示不同的后续步骤
      - 📱 **响应式设计**：适配各种设备的分步体验
